          ...
          <section className="factors-section">
            ...
            <div className="factors-grid-2x2">
              ...
              <div className={getRiskCardClass()}>
                ...
                <div style={{ marginTop: '16px', paddingTop: '10px', borderTop: '1px solid rgba(255, 255, 255, 0.35)', fontSize: '0.75rem', display: 'flex', justifyContent: 'space-between' }}>
                  <span>State:</span>
        ...
        <div className="page-view animate-fade-in">
          ...
          <div className="telemetry-footer-bar">
            <div className="telemetry-footer-info">
              <span className="footer-tag">Sensirion SGP41 (MOX Gas) + Sensirion SHT40 (Temp/RH)</span>
              <span className="footer-sub">Telemetry ingestion via AWS IoT Core MQTT &rarr; SQS &rarr; RDS</span>
            </div>
            <button className="action-btn" onClick={fetchLiveStatus} title="Sync with live stream">
              <RefreshCw size={14} />
              <span>Poll Fresh Ingestion</span>
            </button>
          </div>
        </div>
      )}
